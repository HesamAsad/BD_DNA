...
#BSUB -o /lustre/scratch126/cellgen/lotfollahi/ha11/bd3lms/logs/measured_flops_%J.out
#BSUB -e /lustre/scratch126/cellgen/lotfollahi/ha11/bd3lms/logs/measured_flops_%J.err
set -euo pipefail
