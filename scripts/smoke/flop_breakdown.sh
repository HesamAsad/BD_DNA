...
#BSUB -o /lustre/scratch126/cellgen/lotfollahi/ha11/bd3lms/logs/flop_breakdown_%J.out
#BSUB -e /lustre/scratch126/cellgen/lotfollahi/ha11/bd3lms/logs/flop_breakdown_%J.err
set -euo pipefail
...
"$PYTHON" -u scripts/smoke/flop_breakdown.py
