...
#BSUB -o /lustre/scratch126/cellgen/lotfollahi/ha11/bd3lms/logs/dit_lnequiv_%J.out
#BSUB -e /lustre/scratch126/cellgen/lotfollahi/ha11/bd3lms/logs/dit_lnequiv_%J.err
set -euo pipefail
...
"$PYTHON" -u scripts/smoke/dit_ln_equiv.py
